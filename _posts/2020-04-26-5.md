...
上式为使函数$z=f(x_1,\cdots,x_n)$取得极大值的必要条件。如果函数$f$为凹函数，函数$g^i$为凸函数，则库恩—塔克条件为极大值的充要条件。
...
上式为使函数$z=f(x_1,\cdots,x_n)$取得极小值的必要条件。如果函数$f$为凸函数，函数$g^i$为凹函数，则库恩—塔克条件为极小值的充要条件。